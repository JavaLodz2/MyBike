...
INSERT INTO users (user_id, contact_number, enabled, first_name, last_name, login, password, user_role) VALUES (1, '600700800', 1, 'Jan', 'Kowalski', 'admin', 'admin', 'ROLE_ADMIN');
INSERT INTO users (user_id, contact_number, enabled, first_name, last_name, login, password, user_role) VALUES (2, '600700800', 1, 'Marian', 'Nowak', 'user', 'user', 'ROLE_USER');